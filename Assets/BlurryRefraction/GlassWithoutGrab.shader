...
Properties {
	...
	_BlurPower ("Blur Power", Range(0,1)) = 1.0
...
sampler2D _GrabBlurTexture1;
sampler2D _GrabBlurTexture2;
...
half4 frag (v2f i) : SV_Target
{
	...
	half4 colBlur1 = tex2Dproj (_GrabBlurTexture1, UNITY_PROJ_COORD(i.uvgrab));
	half4 colBlur2 = tex2Dproj (_GrabBlurTexture2, UNITY_PROJ_COORD(i.uvgrab));
	half4 col = lerp (colBlur1, colBlur2, _BlurPower);
